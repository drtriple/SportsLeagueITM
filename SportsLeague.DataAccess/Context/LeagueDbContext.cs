    ...
    public class LeagueDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sponsor>(entity =>
            {
                ...
                entity.Property(s => s.Phone).HasMaxLength(30).IsRequired(false);
                entity.Property(s => s.WebsiteUrl).HasMaxLength(500).IsRequired(false);
                entity.Property(s => s.Category).IsRequired();
                entity.Property(s => s.CreatedAt).IsRequired();
                entity.Property(s => s.UpdatedAt).IsRequired(false);

                // Índice único en Name: no puede haber dos sponsors con el mismo nombre
            ...
            modelBuilder.Entity<MatchLineup>(entity =>
            {
                ...
                // Relación con Match: si se borra el partido, se borran sus alineaciones
                entity.HasOne(ml => ml.Match)
                      .WithMany(m => m.MatchLineups)
                      .HasForeignKey(ml => ml.MatchId)
                      .OnDelete(DeleteBehavior.Cascade);

                // Relación con Player: NO en cascada para evitar múltiples rutas de cascade
                // (Player → Team → Match ya tiene su propia cadena)
